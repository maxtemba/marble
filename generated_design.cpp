...
// Architecture: Block(5x5_conv, {'filter': 128}) -> Block(5x5_conv, {'filter': 128}) -> Block(5x5_conv, {'filter': 32})
#include <cstddef>
...
void top_function(float* input, float* output, int size) {
    ...
    // Block 0: 5x5_conv with 128 filters
    conv(input, output, 128, 5);
    // Block 1: 5x5_conv with 128 filters
    conv(input, output, 128, 5);
    // Block 2: 5x5_conv with 32 filters
